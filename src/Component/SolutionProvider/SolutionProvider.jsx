                ...
                case "graphics-development-services":
                    setServicesIndustries({
                        ...
                        tabsdesc: {
                            ...
                            third: 'AStechy offers specialized graphics designing services for fintech web applications catering to banking, trading, lending, and insurance clients. Our finance designs prioritize robust security, real-time data visualization, and compliance with regulatory standards. With expertise in user-centric design principles, we create intuitive interfaces that facilitate complex financial transactions and provide a seamless user experience.',
                ...
                case "web-application-development-services":
                    setServicesIndustries({
                        ...
                        tabsdesc: {
                            ...
                            third: 'AStechy offers specialized fintech web application development services for banking, trading, lending, and insurance clients. Our finance web apps provide robust security, real-time data, complex calculations, and compliance with regulations. Our proven expertise in building web platforms for stockbrokers, forex brokers, peer-to-peer lenders, and crypto exchanges differentiates us.',
                            fourth: 'Optimizing supply chain workflows is what we excel at. AStechy’s logistics web apps track orders, manage freight, enable dispatching, and provide real-time visibility into the entire distribution cycle. Our logistics clients rely on warehouse integration, vehicle routing, barcode scanning, and other supply chain-focused features we bake into our logistics web app solutions.',
                            fifth: 'AStechy has contributed to the evolution of online learning and campus management in the education sector. From LMS platforms to online course marketplaces, AStechy develops innovative ed-tech web applications to facilitate digital learning. We have developed e-learning platforms, student management systems, and communication tools for educational institutions. Our web app solutions enhance the learning experience by providing educators and students with the tools they need to collaborate and succeed.',
                            sixth: 'The sports industry demands real-time engagement and interaction with fans. AStechy has created web applications for sports teams, leagues, and organizations that enable live score updates, fan engagement, and ticketing solutions. We help sports entities connect with their audiences on a deeper level, fostering loyalty and enthusiasm among fans.',
                            image: webdev
                        }
                    });
                    break;
                case "seo-services":
                    setServicesIndustries({
                        ...
                        tabsdesc: {
                            ...
                            third: 'AStechy provides specialized SEO services for finance-related websites, including banking, trading, lending, and insurance platforms. Our SEO strategies focus on optimizing financial content, improving website performance, and enhancing user experience to increase organic traffic and conversions. With a data-driven approach and industry-specific expertise, we help finance companies rank higher in search engine results and gain a competitive edge.',
                            ...
                            fifth: 'AStechy specializes in SEO services for educational institutions, including schools, colleges, and e-learning platforms. Our SEO strategies focus on optimizing educational content, improving website structure, and increasing organic visibility in search engine results. From optimizing course descriptions to enhancing website speed and mobile-friendliness, our SEO solutions help educational organizations attract more students and boost enrollment.',
                ...
                case "ui-ux-design-services":
                    setServicesIndustries({
                        ...
                        tabsdesc: {
                            ...
                            second: 'AStechy offers specialized real estate UI/UX design services. We design property search, listings, brokerage and property management interfaces that connect effectively with real estate users and their journey.',
                            ...
                            fifth: 'AStechy has partnered with logistics companies to design seamless UI/UX for dispatch, delivery tracking and fleet management solutions used daily by drivers.',
